import meter1 from "../assets/img/meter-79.png";
        ...
        <div className="row">
          <div className="col-12">
            <div className="skill-bx wow zoomIn">
              <h2>Algorithms</h2>
              <p>
                Different Machine Learning and Deep Learning algorithms and
                models<br></br> were developed and their accuracies are:
              </p>
              <Carousel
